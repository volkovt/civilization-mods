...
def main() -> None:
    ...
    require_count(cursor, "hero_art_infos", "SELECT COUNT(*) FROM ArtDefine_UnitInfos WHERE Type LIKE 'ART_DEF_UNIT_SAYAJIN_%'", 5)
    require_count(cursor, "hero_art_members", "SELECT COUNT(*) FROM ArtDefine_UnitMemberInfos WHERE Type LIKE 'ART_DEF_UNIT_MEMBER_SAYAJIN_%'", 5)
    ...
    require_count(cursor, "melee_art_profiles", "SELECT COUNT(*) FROM ArtDefine_UnitMemberCombats WHERE UnitMemberType IN ('ART_DEF_UNIT_MEMBER_SAYAJIN_VEGETA','ART_DEF_UNIT_MEMBER_SAYAJIN_BROLY') AND HasShortRangedAttack=0 AND HasLongRangedAttack=0 AND HasStationaryMelee=1 AND HasStationaryRangedAttack=0", 2)
    require_count(cursor, "ranged_art_profiles", "SELECT COUNT(*) FROM ArtDefine_UnitMemberCombats WHERE UnitMemberType IN ('ART_DEF_UNIT_MEMBER_SAYAJIN_GOKU','ART_DEF_UNIT_MEMBER_SAYAJIN_GOHAN','ART_DEF_UNIT_MEMBER_SAYAJIN_PICCOLO') AND HasShortRangedAttack=1 AND HasLongRangedAttack=1 AND HasStationaryMelee=1 AND HasStationaryRangedAttack=1", 3)
    require_count(cursor, "melee_weapon_profiles", "SELECT COUNT(*) FROM ArtDefine_UnitMemberCombatWeapons WHERE UnitMemberType IN ('ART_DEF_UNIT_MEMBER_SAYAJIN_VEGETA','ART_DEF_UNIT_MEMBER_SAYAJIN_BROLY') AND [Index]=0", 2)
    require_count(cursor, "melee_projectiles", "SELECT COUNT(*) FROM ArtDefine_UnitMemberCombatWeapons WHERE UnitMemberType IN ('ART_DEF_UNIT_MEMBER_SAYAJIN_VEGETA','ART_DEF_UNIT_MEMBER_SAYAJIN_BROLY') AND [Index]<>0", 0)
    require_count(cursor, "ranged_projectiles", "SELECT COUNT(*) FROM ArtDefine_UnitMemberCombatWeapons WHERE UnitMemberType IN ('ART_DEF_UNIT_MEMBER_SAYAJIN_GOKU','ART_DEF_UNIT_MEMBER_SAYAJIN_GOHAN','ART_DEF_UNIT_MEMBER_SAYAJIN_PICCOLO') AND [Index]=1 AND ID='ART_DEF_VEFFECT_PLASMA_RIFLE_PROJ'", 3)
